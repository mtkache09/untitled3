...
- ✅ **Локальный файл**: Используется `/tonconnect-manifest.json`
- ✅ **Без внешних зависимостей**: Не зависит от внешних URL
- ✅ **Поддержка TON Proof**: Включена поддержка `ton_proof`
- ✅ **Простая отладка**: Легко проверить доступность файла
- ✅ **Локальная разработка**: Работает с локальным сервером
